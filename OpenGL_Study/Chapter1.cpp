...
public:
	...
	static int Start()
	{
		...
		GLFWwindow* window = glfwCreateWindow(Chapter1::SCR_WIDTH, Chapter1::SCR_HEIGHT, "LearnOpenGL", NULL, NULL);
		if (window == NULL)
		{
		...
		glfwSetFramebufferSizeCallback(window, Chapter1::framebuffer_size_callback);
